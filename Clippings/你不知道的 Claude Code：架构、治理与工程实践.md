...
created: 2026-07-25
description: "我把我最近半年每个月氪金40刀2个账号的claude code 使用过程中，积累的一些实际经验分享给大伙。这篇文章主要围绕上下文管理、Skills、Hooks、Subagents、Prompt Caching 以及 CLAUDE.md 的设计展开，重点讨论怎样让协作过程更稳定、更可控，偏工程师技术视角的最佳实践，..."
tags:
  - "clippings"
---
<svg width="100%" height="200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" role="img" aria-label="運用之妙，存乎一心"><path id="svg-title-path"></path><text font-size="42" font-weight="400" fill="#ffffff" x="50%" y="50%" text-anchor="middle" word-spacing="2.0" letter-spacing="4"><textPath xlink:href="#svg-title-path">運用之妙，存乎一心</textPath></text></svg>
...
![Agent Loop](https://cdn.tw93.fun/blog/upic/QrTwEC.svg)
...
![Context Loading](https://cdn.tw93.fun/blog/upic/1auitO.svg)
...
![](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/g1Ce7x.png)
...
![/context 命令输出，可以看到各来源的 token 占比](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/DOPgjN.png)
...
![Session Continuity](https://cdn.tw93.fun/blog/upic/HQlqLw.svg)
...
![](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/6qvOIC.png)
...
![](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/iOfkNM.png)
...
![Finding the sweet spot](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/aMfLwM.png)
...
![Improving Elicitation & the AskUserQuestion tool](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/JHqSz5.png)
...
![Updating with Capabilities - Tasks & Todos](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/hXrzJK.png)
...
![Hooks 配置界面](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/5J83L4.png)
...
![Hooks 在执行过程中的介入点](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/O9aa1Q.png)
...
![Lay Out Your Prompt for Caching](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/tCDytz.png)
...
![Forking Context — Compaction](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/0M2eXx.png)
...
![/mcp 连接状态，可以看到各 server 的工具数量和 token 消耗](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/XwDs5n.png)
...
![Keep it simple](https://cdn.tw93.fun/cdn-cgi/image/width=2000,quality=80,format=auto,fit=scale-down/blog/upic/6IysXR.jpg)
